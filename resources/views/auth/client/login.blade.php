...
<head>
	...
	<!--begin::Base Styles -->
	<link href="/assets/auth/vendors/base/vendors.bundle.css" rel="stylesheet" type="text/css" />

	<!--RTL version:<link href="/assets/auth/vendors/base/vendors.bundle.rtl.css" rel="stylesheet" type="text/css" />-->
	<link href="/assets/auth/demo/default/base/style.bundle.css" rel="stylesheet" type="text/css" />

	<!--RTL version:<link href="/assets/auth/demo/default/base/style.bundle.rtl.css" rel="stylesheet" type="text/css" />-->

	<!--end::Base Styles -->
	<link rel="shortcut icon" href="/assets/auth/demo/default/media/img/logo/favicon.ico" />
</head>
...
<body class="m--skin- m-header--fixed m-header--fixed-mobile m-aside-left--enabled m-aside-left--skin-dark m-aside-left--fixed m-aside-left--offcanvas m-footer--push m-aside--offcanvas-default">
	...
	<div class="m-grid m-grid--hor m-grid--root m-page">
		<div class="m-grid__item m-grid__item--fluid   m-grid m-grid--desktop m-grid--ver-desktop m-grid--hor-tablet-and-mobile   m-login m-login--6" id="m_login">
			<div class="m-grid__item   m-grid__item--order-tablet-and-mobile-2  m-grid m-grid--hor m-login__aside " style="background-image: url(/assets/auth/app/media/img//bg/bg-4.jpg);">
				<div class="m-grid__item">
					<div class="m-login__logo">
						<a href="#">
							<img src="/assets/auth/app/media/img//logos/logo-4.png">
						</a>
					</div>
				</div>
				<div class="m-grid__item m-grid__item--fluid m-grid m-grid--ver">
					<div class="m-grid__item m-grid__item--middle">
						<span class="m-login__title">Platformator</span>
						<span class="m-login__subtitle">Create, distribute and manage custom systems without any coding.</span>
					</div>
				</div>
				<div class="m-grid__item">
	...
	<!--begin::Base Scripts -->
	<script src="/assets/auth/vendors/base/vendors.bundle.js" type="text/javascript"></script>
	<script src="/assets/auth/demo/default/base/scripts.bundle.js" type="text/javascript"></script>
